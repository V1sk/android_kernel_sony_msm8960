...
static struct platform_device rdtags_device = {
 ...
 #define DEBUG_MEMORY_SIZE ((MSM_RAM_CONSOLE_SIZE) + (CONFIG_RAMDUMP_TAGS_SIZE))
#elif defined(CONFIG_ANDROID_RAM_CONSOLE)
 #define DEBUG_MEMORY_SIZE (MSM_RAM_CONSOLE_SIZE)
#elif defined(CONFIG_RAMDUMP_TAGS)
 #define DEBUG_MEMORY_SIZE (CONFIG_RAMDUMP_TAGS_SIZE)
#endif
...
#endif /* CONFIG_RAMDUMP_CRASH_LOGS */
...
struct synaptics_pointer_data pointer_data_0x22 = {
	.offset_x = 0,
	.offset_y = 19,
};
...
struct synaptics_funcarea clearpad_funcarea_array_0x22[] = {
	{
		{ 0, 19, 539, 978 }, { 0, 0, 539, 978 },
		SYN_FUNCAREA_POINTER, &pointer_data_0x22
	},
	{ .func = SYN_FUNCAREA_END }
};
...
struct synaptics_funcarea *clearpad_funcarea_get(u8 module_id, u8 rev)
{
	...
	case 0x22:
	case 0x23:
		funcarea = clearpad_funcarea_array_0x22;
		break;
	default:
