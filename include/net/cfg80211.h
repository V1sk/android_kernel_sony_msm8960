...
/**
 * cfg80211_update_country - notify cfg80211 new country code
 *
 * @country_code: new country code get from 11d packet.
 *
 * This informs cfg80211 that new country code was found.
 */
void cfg80211_update_country(const char *country_code);
